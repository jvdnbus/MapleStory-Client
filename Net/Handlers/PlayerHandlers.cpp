...
namespace ms {
    void ChangeChannelHandler::handle(InPacket& recv) {
    ...
    void ChangeStatsHandler::handle(InPacket& recv) {
    ...
    void BuffHandler::handle(InPacket& recv) {
    ...
    void RecalculateStatsHandler::handle(InPacket&) {
        Stage::get().get_player().recalc_stats(false);
    }

    void UpdateSkillHandler::handle(InPacket& recv) {
        recv.skip(3);
    ...
    void SkillMacrosHandler::handle(InPacket& recv) {
    ...
    void AddCooldownHandler::handle(InPacket& recv) {
    ...
    void KeymapHandler::handle(InPacket& recv) {
        recv.skip(1);
