...
namespace ms {
    void SpawnCharHandler::handle(InPacket& recv) {
    ...
    void RemoveCharHandler::handle(InPacket& recv) {
        int32_t cid = recv.read_int();

        Stage::get().get_chars().remove(cid);
    }

    void SpawnPetHandler::handle(InPacket& recv) {
        int32_t cid = recv.read_int();
    ...
    void ShowForeignEffectHandler::handle(InPacket& recv) {
        int32_t cid = recv.read_int();
    ...
    void SpawnMobHandler::handle(InPacket& recv) {
    ...
    void KillMobHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
    ...
    void SpawnMobControllerHandler::handle(InPacket& recv) {
        int8_t mode = recv.read_byte();
        int32_t oid = recv.read_int();
    ...
    void MobMovedHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
    ...
    void ShowMobHpHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
    ...
    void SpawnNpcHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
        int32_t id = recv.read_int();
        Point<int16_t> position = recv.read_point();
    ...
    void SpawnNpcControllerHandler::handle(InPacket& recv) {
        int8_t mode = recv.read_byte();
        int32_t oid = recv.read_int();
    ...
    void DropLootHandler::handle(InPacket& recv) {
        int8_t mode = recv.read_byte();
        int32_t oid = recv.read_int();
    ...
    void RemoveLootHandler::handle(InPacket& recv) {
        int8_t mode = recv.read_byte();
        int32_t oid = recv.read_int();
    ...
    void HitReactorHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
    ...
    void SpawnReactorHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
    ...
    void RemoveReactorHandler::handle(InPacket& recv) {
        int32_t oid = recv.read_int();
        int8_t state = recv.read_byte();
        Point<int16_t> point = recv.read_point();
