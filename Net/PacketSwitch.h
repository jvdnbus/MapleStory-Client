...
namespace ms {
    ...
    private:
        ...
        static constexpr auto MSG_UNHANDLED = "Unhandled packet detected";
        // Message when a packet with a larger opcode than the array size is received
        static constexpr auto MSG_OUTOFBOUNDS = "Large opcode detected";
        // Message when a packet with a larger opcode than the array size is received
        static constexpr auto MSG_REREGISTER = "Handler was registered twice";
