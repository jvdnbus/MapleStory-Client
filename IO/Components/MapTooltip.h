...
namespace ms {
    ...
    public:
        ...
        void set_title(Parent parent, std::string title, bool bolded);
    ...
    private:
        ...
        static constexpr auto SEPARATOR_ADJ = Point<int16_t>(1, 10);
        static constexpr auto LIFE_LABEL_ADJ = Point<int16_t>(16, 3);
        static constexpr auto LIFE_ICON_ADJ = Point<int16_t>(1, 9);
