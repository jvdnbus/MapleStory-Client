...
namespace ms {
    ...
    Textfield::Textfield(Text::Font font, Text::Alignment alignment, Color::Name text_color, Rectangle<int16_t> b,
                         size_t limit, int16_t marker_height) : bounds(b), limit(limit) {
