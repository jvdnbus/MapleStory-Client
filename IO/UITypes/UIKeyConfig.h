    ...
    private:
        ...
        std::map<int32_t, Keyboard::Mapping> alternate_keys =
        {
            ...
            {KeyConfig::Key::F8, Keyboard::Mapping(get_keytype(KeyAction::Id::FACE7), KeyAction::Id::FACE7)},
            {
                ...
                Keyboard::Mapping(get_keytype(KeyAction::Id::SCREENSHOT), KeyAction::Id::SCREENSHOT)
            },
            {
                KeyConfig::Key::GRAVE_ACCENT,
                Keyboard::Mapping(get_keytype(KeyAction::Id::CASHSHOP), KeyAction::Id::CASHSHOP)
            },
            ...
            {KeyConfig::Key::HOME, Keyboard::Mapping(get_keytype(KeyAction::Id::PARTYCHAT), KeyAction::Id::PARTYCHAT)},
            {
                ...
                Keyboard::Mapping(get_keytype(KeyAction::Id::FRIENDSCHAT), KeyAction::Id::FRIENDSCHAT)
            },
            ...
            {KeyConfig::Key::LEFT_BRACKET, Keyboard::Mapping(get_keytype(KeyAction::Id::MENU), KeyAction::Id::MENU)},
            {
                ...
                Keyboard::Mapping(get_keytype(KeyAction::Id::QUICKSLOTS), KeyAction::Id::QUICKSLOTS)
            },
            {
                KeyConfig::Key::BACKSLASH,
                Keyboard::Mapping(get_keytype(KeyAction::Id::KEYBINDINGS), KeyAction::Id::KEYBINDINGS)
            },
            {
                KeyConfig::Key::DELETE,
                Keyboard::Mapping(get_keytype(KeyAction::Id::GUILDCHAT), KeyAction::Id::GUILDCHAT)
            },
            {
                KeyConfig::Key::END,
                Keyboard::Mapping(get_keytype(KeyAction::Id::ALLIANCECHAT), KeyAction::Id::ALLIANCECHAT)
            },
            ...
            {KeyConfig::Key::SEMICOLON, Keyboard::Mapping(get_keytype(KeyAction::Id::MEDALS), KeyAction::Id::MEDALS)},
            {
                ...
                Keyboard::Mapping(get_keytype(KeyAction::Id::TOGGLECHAT), KeyAction::Id::TOGGLECHAT)
            },
            ...
            {KeyConfig::Key::PERIOD, Keyboard::Mapping(get_keytype(KeyAction::Id::FRIENDS), KeyAction::Id::FRIENDS)},
            {
                ...
                Keyboard::Mapping(get_keytype(KeyAction::Id::ATTACK), KeyAction::Id::ATTACK)
            },
            {KeyConfig::Key::LEFT_ALT, Keyboard::Mapping(get_keytype(KeyAction::Id::JUMP), KeyAction::Id::JUMP)},
            {
                KeyConfig::Key::SPACE,
                Keyboard::Mapping(get_keytype(KeyAction::Id::INTERACT_HARVEST), KeyAction::Id::INTERACT_HARVEST)
            },
        ...
        std::map<int32_t, Keyboard::Mapping> basic_keys =
        {
            ...
            {
                KeyConfig::Key::O,
                Keyboard::Mapping(get_keytype(KeyAction::Id::ENHANCEEQUIP), KeyAction::Id::ENHANCEEQUIP)
            },
            {KeyConfig::Key::P, Keyboard::Mapping(get_keytype(KeyAction::Id::PARTY), KeyAction::Id::PARTY)},
            {KeyConfig::Key::LEFT_BRACKET, Keyboard::Mapping(get_keytype(KeyAction::Id::MENU), KeyAction::Id::MENU)},
            {
