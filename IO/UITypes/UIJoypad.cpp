...
namespace ms {
    ...
    UIJoypad::UIJoypad() : UIDragElement<PosJOYPAD>() {
        ...
        buttons[DEFAULT] = std::make_unique<MapleButton>(JoyPad["BtDefault"]);
        buttons[CANCEL] = std::make_unique<MapleButton>(Basic["BtCancel4"], Point<int16_t>(124, 303));
        buttons[OK] = std::make_unique<MapleButton>(Basic["BtOK4"], Point<int16_t>(82, 303));
