...
namespace ms {
    UIShop::UIShop(const CharLook& in_charlook, const Inventory& in_inventory) : UIDragElement<PosSHOP>(),
        ...
        checkBox[false] = cbdis;
        checkBox[true] = cben;

        buttons[CHECKBOX] = std::make_unique<AreaButton>(Point<int16_t>(std::abs(cb_x), std::abs(cb_y)),
                                                         cben.get_dimensions());
    ...
    void UIShop::BuyState::buy() const {
        ...
        if (buyable > 1) {
            constexpr auto question = "How many are you willing to buy?";
            ...
            constexpr auto question = "Are you sure you want to buy it?";
    ...
    void UIShop::SellState::sell(bool skip_confirmation) const {
        ...
        if (sellable > 1) {
            constexpr auto question = "How many are you willing to sell?";
            ...
            constexpr auto question = "Are you sure you want to sell it?";
