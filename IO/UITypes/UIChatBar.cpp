...
namespace ms {
    UIChatBar::UIChatBar() : temp_view_x(0), temp_view_y(0), view_input(false), view_adjusted(false),
                             position_adjusted(false), drag_direction(NONE) {
        ...
        buttons[BtMax] = std::make_unique<MapleButton>(view["btMax"], Point<int16_t>(min_x - btMax_x - 5, -7));
        buttons[BtMin] = std::make_unique<MapleButton>(view["btMin"]);

        auto input_btns_pos = Point<int16_t>(input_max_x - (input_bg_x - user_view_x) + input_origin_x - 17,
                                             15 + input_origin_y + 1);
        int16_t input_btns_padding = 3;
        input_btns_x = Texture(input["button:chat"]["normal"]["0"]).width() + input_btns_padding;

        buttons[BtChat] = std::make_unique<MapleButton>(input["button:chat"],
                                                        input_btns_pos + Point<int16_t>(input_btns_x * 0, 0));
        buttons[BtItemLink] = std::make_unique<MapleButton>(input["button:itemLink"],
                                                            input_btns_pos + Point<int16_t>(
                                                                input_btns_x * 1, 0));
        buttons[BtChatEmoticon] = std::make_unique<MapleButton>(
            input["button:chatEmoticon"], input_btns_pos + Point<int16_t>(input_btns_x * 2, 0));
        buttons[BtHelp] = std::make_unique<MapleButton>(input["button:help"],
                                                        input_btns_pos + Point<int16_t>(input_btns_x * 3, 0));
        buttons[BtOutChat] = std::make_unique<MapleButton>(input["button:outChat"],
                                                           input_btns_pos + Point<
                                                               int16_t>(input_btns_x * 4, 0));

        buttons[BtChat]->set_active(false);
        buttons[BtItemLink]->set_active(false);
        buttons[BtChatEmoticon]->set_active(false);
        buttons[BtHelp]->set_active(false);
        buttons[BtOutChat]->set_active(false);
        ...
        input_text = Textfield(
            ...
            Rectangle<int16_t>(get_input_text_position(),
                               get_input_text_position() + Point<int16_t>(283, INPUT_TEXT_HEIGHT)),
        ...
        show_message("[Welcome] Welcome to MapleStory!!", YELLOW);
    }

    void UIChatBar::draw(float inter) const {
        if (view_max) {
            auto vertical = Range<int16_t>(0, 0);

            max_textures[0].draw(position - Point<int16_t>(0, center_y + user_view_y), vertical,
                                 Range<int16_t>(0, max_x - user_view_x + 5));
            max_textures[0].draw(position - Point<int16_t>(max_x - user_view_x, center_y + user_view_y), vertical,
                                 Range<int16_t>(max_x - 5, 0));

            max_textures[1].draw(
                DrawArgument(position - Point<int16_t>(0, center_y + user_view_y), Point<int16_t>(0, user_view_y + 1)),
                vertical, Range<int16_t>(0, max_x - user_view_x + 2));
            max_textures[1].draw(
                DrawArgument(position - Point<int16_t>(max_x - user_view_x, center_y + user_view_y),
                             Point<int16_t>(0, user_view_y + 1)), vertical, Range<int16_t>(max_x - 2, 0));

            max_textures[2].draw(position, vertical, Range<int16_t>(0, max_x - user_view_x + 5));
            max_textures[2].draw(position - Point<int16_t>(max_x - user_view_x, 0), vertical,
                                 Range<int16_t>(max_x - 5, 0));
            ...
            for (int i = message_history.size() - 1; i >= 0; i--) {
                if (message_y <= center_y + user_view_y) {
                    message_history[i].text.draw(
                        position - Point<int16_t>(drag.get_origin().x() - 2, 5) - Point<int16_t>(0, message_y));
            ...
            if (view_input) {
                ...
                input_textures[0].draw(pos - Point<int16_t>(input_bg_x - user_view_x, 0), vertical,
                                       Range<int16_t>(input_bg_x - 5, 0));

                input_textures[1].draw(pos, vertical,
                                       Range<int16_t>(
                                           0, input_max_x - (input_bg_x - user_view_x) - input_origin_x - 22 + 3));
                input_textures[1].draw(
                    pos - Point<int16_t>(input_max_x - (input_bg_x - user_view_x) - input_origin_x - 22, 0), vertical,
                    Range<int16_t>(input_max_x - 3, 0));
            ...
            if (dragged) {
                if (temp_view_y > 0 && temp_view_x == 0) {
                    ...
                    max_textures[0].draw(pos - Point<int16_t>(0, center_y + temp_view_y), vertical,
                                         Range<int16_t>(0, max_x - user_view_x + 5));
                    max_textures[0].draw(pos - Point<int16_t>(max_x - user_view_x, center_y + temp_view_y), vertical,
                                         Range<int16_t>(max_x - 5, 0));

                    max_textures[1].draw(
                        DrawArgument(pos - Point<int16_t>(0, center_y + temp_view_y),
                                     Point<int16_t>(0, temp_view_y + 1)), vertical,
                        Range<int16_t>(0, max_x - user_view_x + 2));
                    max_textures[1].draw(
                        DrawArgument(pos - Point<int16_t>(max_x - user_view_x, center_y + temp_view_y),
                                     Point<int16_t>(0, temp_view_y + 1)), vertical, Range<int16_t>(max_x - 2, 0));

                    max_textures[2].draw(pos, vertical, Range<int16_t>(0, max_x - user_view_x + 5));
                    max_textures[2].draw(pos - Point<int16_t>(max_x - user_view_x, 0), vertical,
                                         Range<int16_t>(max_x - 5, 0));
                    ...
                    max_textures[0].draw(pos - Point<int16_t>(0, center_y + user_view_y), vertical,
                                         Range<int16_t>(0, max_x - temp_view_x + 5));
                    max_textures[0].draw(pos - Point<int16_t>(max_x - temp_view_x, center_y + user_view_y), vertical,
                                         Range<int16_t>(max_x - 5, 0));

                    max_textures[1].draw(
                        DrawArgument(pos - Point<int16_t>(0, center_y + user_view_y),
                                     Point<int16_t>(0, user_view_y + 1)), vertical,
                        Range<int16_t>(0, max_x - temp_view_x + 2));
                    max_textures[1].draw(
                        DrawArgument(pos - Point<int16_t>(max_x - temp_view_x, center_y + user_view_y),
                                     Point<int16_t>(0, user_view_y + 1)), vertical, Range<int16_t>(max_x - 2, 0));

                    max_textures[2].draw(pos, vertical, Range<int16_t>(0, max_x - temp_view_x + 5));
                    max_textures[2].draw(pos - Point<int16_t>(max_x - temp_view_x, 0), vertical,
                                         Range<int16_t>(max_x - 5, 0));
                } else if (temp_view_y > 0 && temp_view_x > 0) {
                    Point<int16_t> pos = position;

                    if (drag_direction == DOWN || drag_direction == LEFT || drag_direction
                        == DOWNLEFT)
                        pos = temp_position;

                    max_textures[0].draw(pos - Point<int16_t>(0, center_y + temp_view_y), vertical,
                                         Range<int16_t>(0, max_x - temp_view_x + 5));
                    max_textures[0].draw(pos - Point<int16_t>(max_x - temp_view_x, center_y + temp_view_y), vertical,
                                         Range<int16_t>(max_x - 5, 0));
                    ...
                    max_textures[1].draw(
                        ...
                        Range<int16_t>(0, max_x - temp_view_x + 2));
                    max_textures[1].draw(
                        DrawArgument(pos - Point<int16_t>(max_x - temp_view_x, center_y + temp_view_y),
                                     Point<int16_t>(0, temp_view_y + 1)), vertical, Range<int16_t>(max_x - 2, 0));
            ...
            if (size > 0)
                message_history[size - 1].text.draw(
                    position - Point<int16_t>(0, top_y + center_y) + Point<int16_t>(
                        drag.get_origin().abs().x(), drag.height()) + Point<int16_t>(2, 7));
        }
    ...
    void UIChatBar::update() {
        input_text.update(get_input_text_position(),
                          Point<int16_t>(input_max_x - (input_bg_x - user_view_x) - 22, INPUT_TEXT_HEIGHT));
    }
    ...
    bool UIChatBar::is_in_range(Point<int16_t> cursor_position) const {
        if (temp_view_y == 0 && temp_view_x == 0) {
            auto bounds = Rectangle<int16_t>(get_position(), get_position() + dimension);
            auto input_bounds = Rectangle<int16_t>(get_input_position(),
                                                   get_input_position() + Point<int16_t>(
                                                       user_view_x, input_bg_y));
    ...
    Cursor::State UIChatBar::send_cursor(bool clicked, Point<int16_t> cursor_position) {
        ...
        if (clicked) {
            if (dragged) {
                ...
                if (temp_view_x == 0) {
                    if (drag_direction == DOWN) {
                        ...
                        Point<int16_t> pos_y = cursor_position - position + Point<int16_t>(0, user_view_y) - Point<
                            int16_t>(0, 13);
                        ...
                        if (pos_y.y() <= MIN_HEIGHT) {
                            ...
                            temp_position = position - Point<int16_t>(0, user_view_y) + Point<int16_t>(
                                0, MAX_HEIGHT);
                        } else {
                            temp_view_y = pos_y.y();
                ...
                if (drag_direction == DOWNLEFT) {
                    ...
                    if (drag_direction == LEFT) {
                        ...
                        if (pos_x.x() <= min_x) {
                            temp_view_x = min_x;
                            temp_position = position + Point<int16_t>(user_view_x, 0) - Point<
                                int16_t>(min_x, 0);
                        } else if (pos_x.x() >= max_x) {
                            temp_view_x = max_x;
                            temp_position = position - Point<int16_t>(max_x, 0) + Point<
                                int16_t>(user_view_x, 0);
                        } else {
                            temp_view_x = pos_x.x();
                            temp_position = Point<int16_t>(pos.x(), position.y());
                        }
                    ...
                    if (drag_direction == DOWN) {
                        // TODO: The top gets shifted by a pixel
                        Point<int16_t> pos_y = cursor_position - position + Point<int16_t>(0, user_view_y) -
                            Point<int16_t>(0, 13);
                        Point<int16_t> pos = cursor_position - cursoroffset;
                ...
                if (drag_direction == DOWN || drag_direction == LEFT)
                    return Cursor::State::CHATBARBRTLDRAG;
                return Cursor::State::CHATBARBLTRDRAG;
            }
            if (indragrange(cursor_position)) {
            ...
            if (view_max) {
                ...
                if (inrightrange(cursor_position) && !intoprange(cursor_position) && !inbottomrange(
                    cursor_position)) {
                    dragged = true;
                ...
                if (intoprightrange(cursor_position)) {
                    dragged = true;
                ...
                if (inbottomrange(cursor_position) && !inleftrange(cursor_position) && !inrightrange(
                    cursor_position)) {
                    cursoroffset = cursor_position - position;
                    dragged = true;
                ...
                if (inbottomrightrange(cursor_position)) {
                    cursoroffset = cursor_position - position;
                    dragged = true;
                ...
                if (inleftrange(cursor_position) && !intoprange(cursor_position) && !
                    inbottomrange(cursor_position)) {
                    cursoroffset = cursor_position - position;
                    dragged = true;
                ...
                if (intopleftrange(cursor_position)) {
                    cursoroffset = cursor_position - position;
                    dragged = true;
                ...
                if (inbottomleftrange(cursor_position)) {
                    cursoroffset = cursor_position - position;
                    dragged = true;
            ...
            if (view_max) {
                if (intopleftrange(cursor_position) || inbottomrightrange(cursor_position))
                    return Cursor::State::CHATBARBRTLDRAG;
                if (intoprightrange(cursor_position) || inbottomleftrange(cursor_position))
                    return Cursor::State::CHATBARBLTRDRAG;
                if (intoprange(cursor_position) || inbottomrange(cursor_position))
                    return Cursor::State::CHATBARVDRAG;
                if (inleftrange(cursor_position) || inrightrange(cursor_position))
                    return Cursor::State::CHATBARHDRAG;
            }
        }
    ...
    void UIChatBar::show_message(const char* message, MessageType type) {
        ...
        message_history.emplace_back(ALL, type, Text(Text::Font::A11M, Text::Alignment::LEFT, color, message));
    }

    bool UIChatBar::indragrange(Point<int16_t> cursor_position) const {
        auto bounds = Rectangle<int16_t>(get_dragarea_position(), get_dragarea_position() + dragarea);

        return bounds.contains(cursor_position);
    }

    bool UIChatBar::intoprange(Point<int16_t> cursor_position) const {
        auto bounds = Rectangle<int16_t>(get_position(), get_position() + Point<int16_t>(dimension.x(), 3));
    ...
    bool UIChatBar::inbottomrange(Point<int16_t> cursor_position) const {
        ...
        auto bounds = Rectangle<int16_t>(position, position + Point<int16_t>(dimension.x(), 3));

        return bounds.contains(cursor_position);
    }

    bool UIChatBar::inleftrange(Point<int16_t> cursor_position) const {
        auto bounds = Rectangle<int16_t>(get_position(), get_position() + Point<int16_t>(3, dimension.y()));
    ...
    bool UIChatBar::inrightrange(Point<int16_t> cursor_position) const {
        ...
        auto bounds = Rectangle<int16_t>(position, position + Point<int16_t>(3, dimension.y()));
    ...
    Point<int16_t> UIChatBar::get_input_text_position() {
        auto adjust = Point<int16_t>(57, 20);
    ...
    void UIChatBar::toggle_input(bool enabled) {
        ...
        buttons[BtChat]->set_active(view_input);
        buttons[BtItemLink]->set_active(view_input);
        buttons[BtChatEmoticon]->set_active(view_input);
        buttons[BtHelp]->set_active(view_input);
        buttons[BtOutChat]->set_active(view_input);
    }
    ...
    void UIChatBar::toggle_view(bool max, bool pressed) {
        ...
        buttons[BtMax]->set_active(!view_max);
        buttons[BtMin]->set_active(view_max);
    ...
    void UIChatBar::update_view(bool pressed) {
        ...
        auto btMin_padding = Point<int16_t>(-4, 3);

        if (view_max) {
            dimension = Point<int16_t>(user_view_x, top_y + center_y + bottom_y) + Point<int16_t>(0, user_view_y);

            buttons[BtMin]->set_position(Point<int16_t>(user_view_x - btMin_x, -top_y - center_y - user_view_y) + btMin_padding);

            auto input_btns_pos = Point<int16_t>(input_max_x - (input_bg_x - user_view_x) + input_origin_x - 17, 15 + input_origin_y + 1);

            buttons[BtChat]->set_position(input_btns_pos + Point<int16_t>(input_btns_x * 0, 0));
            buttons[BtItemLink]->set_position(input_btns_pos + Point<int16_t>(input_btns_x * 1, 0));
            buttons[BtChatEmoticon]->set_position(input_btns_pos + Point<int16_t>(input_btns_x * 2, 0));
            buttons[BtHelp]->set_position(input_btns_pos + Point<int16_t>(input_btns_x * 3, 0));
            buttons[BtOutChat]->set_position(input_btns_pos + Point<int16_t>(input_btns_x * 4, 0));
        } else {
            dimension = Point<int16_t>(min_x, top_y + center_y + bottom_y);

            buttons[BtMin]->set_position(Point<int16_t>(min_x - btMin_x, -top_y - center_y - user_view_y) + btMin_padding);
        }
