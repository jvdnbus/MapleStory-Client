...
namespace ms {
    UIChat::UIChat() : UIDragElement<PosMAPLECHAT>() {
        ...
        buttons[CLOSE] = std::make_unique<MapleButton>(socialChatEnter["btX"]);
        buttons[CHAT_DUO] = std::make_unique<MapleButton>(socialChatEnter["duoChat"]);
        buttons[CHAT_FRIEND] = std::make_unique<MapleButton>(socialChatEnter["groupChatFrd"]);
        buttons[CHAT_RANDOM] = std::make_unique<MapleButton>(socialChatEnter["groupChatRnd"]);
    ...
    UIRank::UIRank() : UIDragElement<PosMAPLECHAT>() {
        ...
        buttons[CLOSE] = std::make_unique<MapleButton>(socialRank["btX"]);
